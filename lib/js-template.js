...
function readString(buf, offset, length, encoding = 'utf8') {
  ...
  let zi = res.indexOf('\x00');
  if(zi>-1) return res.slice(0, zi);
  return res;
}
...
class virtual extends Type {
  static size(offset) { return 0; }
  size(offset) { return 0; }
  read(buf, offset, object, transform) { console.log(object); return offset; }
  write(buf, offset) { return offset; }
  compare(other) { return true; }
}
