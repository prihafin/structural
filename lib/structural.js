...
exports.Actions = class Actions {
  ...
  structdecl(input, start, end, elements) {
    ...
    let res = {name:name, declarations:aliases, type:"struct", fields:elements[6].fields};
    return res;
  }
  ...
  structfield(input, start, end, e) {
    let res = {ident:e[0].ident, type:e[0].type, modifiers:e[0].modifiers, length:e[0].length};
    if(e[0].encoding) res.encoding = e[0].encoding;
