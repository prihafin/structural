          ...
          if (address3 !== FAILURE) {
            ...
            while (address5 !== FAILURE) {
              ...
              if (elements2 === null) {
                ...
                address5 = new TreeNode10(this._input.substring(index3, this._offset), index3, elements2);
                this._offset = this._offset;
              }
              if (address5 !== FAILURE) {
    ...
    _read_lambdaexpr: function() {
      ...
      while (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address1 = new TreeNode17(this._input.substring(index2, this._offset), index2, elements1);
          this._offset = this._offset;
        }
        if (address1 !== FAILURE) {
          elements0.push(address1);
