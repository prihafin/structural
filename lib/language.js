        ...
        if (address1 === FAILURE) {
          ...
          if (address1 === FAILURE) {
            ...
            if (address6 !== FAILURE) {
              ...
              address7 = this._read_typedefenumdecl();
              if (address7 !== FAILURE) {
              ...
              if (address5 !== FAILURE) {
                ...
                if (address6 !== FAILURE) {
                  ...
                  if (address7 !== FAILURE) {
                    ...
                    address8 = this._read_ws();
                    if (address8 === FAILURE) {
                      address8 = new TreeNode(this._input.substring(index3, index3), index3);
                      this._offset = index3;
                    }
                    if (address8 !== FAILURE) {
                      ...
                      if (address9 !== FAILURE) {
                        ...
                        address10 = this._read_ws();
                        if (address10 === FAILURE) {
                          address10 = new TreeNode(this._input.substring(index4, index4), index4);
                          this._offset = index4;
                        }
                        if (address10 !== FAILURE) {
                          ...
                          if (address11 !== FAILURE) {
                            ...
                            if (address12 === FAILURE) {
                              address12 = new TreeNode(this._input.substring(index5, index5), index5);
                              this._offset = index5;
                            }
                            if (address12 !== FAILURE) {
