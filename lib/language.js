(function() {
  ...
  var TreeNode18 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['typedefstruct'] = elements[2];
    this['structfields'] = elements[9];
    this['eol'] = elements[15];
  };
  ...
  var TreeNode46 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['ident'] = elements[4];
    this['eol'] = elements[12];
  };
  inherit(TreeNode46, TreeNode);

  var TreeNode47 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['ws'] = elements[2];
    this['number'] = elements[3];
  };
  inherit(TreeNode47, TreeNode);

  var TreeNode48 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['ident'] = elements[0];
  };
  inherit(TreeNode48, TreeNode);

  var TreeNode49 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['arithmetic'] = elements[1];
    this['value'] = elements[3];
  };
  inherit(TreeNode49, TreeNode);

  var TreeNode50 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['ws'] = elements[1];
  };
  inherit(TreeNode50, TreeNode);

  var TreeNode51 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['value'] = elements[0];
  };
  inherit(TreeNode51, TreeNode);

  var TreeNode52 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['arithmetic'] = elements[1];
    this['value'] = elements[3];
  };
  inherit(TreeNode52, TreeNode);
  ...
  var Grammar = {
    ...
    _read_decls: function() {
      ...
      while (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          address3 = this._read_namespacedecl();
          if (address3 !== FAILURE) {
                    ...
                    if (address1 === FAILURE) {
                      ...
                      if (address1 === FAILURE) {
                        ...
                        if (address1 === FAILURE) {
                          ...
                          if (address1 === FAILURE) {
                            this._offset = index2;
                            var index23 = this._offset, elements11 = new Array(2);
                            var address22 = FAILURE;
                            var index24 = this._offset;
                            address22 = this._read_ws();
                            if (address22 === FAILURE) {
                              address22 = new TreeNode(this._input.substring(index24, index24), index24);
                              this._offset = index24;
                            }
                            if (address22 !== FAILURE) {
                              elements11[0] = address22;
                              var address23 = FAILURE;
                              address23 = this._read_sysinclude();
                              if (address23 !== FAILURE) {
                                elements11[1] = address23;
                              } else {
                                elements11 = null;
                                this._offset = index23;
                              }
                            } else {
                              elements11 = null;
                              this._offset = index23;
                            ...
                            if (elements11 === null) {
                              ...
                              address1 = new TreeNode11(this._input.substring(index23, this._offset), index23, elements11);
                              this._offset = this._offset;
                            }
                            if (address1 === FAILURE) {
                              this._offset = index2;
          ...
          if (address3 !== FAILURE) {
            ...
            while (address5 !== FAILURE) {
              ...
              if (elements2 === null) {
                ...
                address5 = new TreeNode13(this._input.substring(index3, this._offset), index3, elements2);
                this._offset = this._offset;
              }
              if (address5 !== FAILURE) {
    ...
    _read_hidden: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._hidden = this._cache._hidden || {};
      var cached = this._cache._hidden[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (chunk0 === 'hidden') {
        address0 = this._actions.hidden(this._input, this._offset, this._offset + 6);
        ...
        if (this._offset === this._failure) {
          this._expected.push('"hidden"');
        }
      }
      this._cache._hidden[index0] = [address0, this._offset];
      return address0;
    },
    ...
    _read_namespacedecl: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._namespacedecl = this._cache._namespacedecl || {};
      var cached = this._cache._namespacedecl[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.namespacedecl(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._namespacedecl[index0] = [address0, this._offset];
      return address0;
    },
    ...
    _read_typedefstructdecl: function() {
      ...
      var index1 = this._offset, elements0 = new Array(17);
      var address1 = FAILURE;
      var index2 = this._offset;
      address1 = this._read_hidden();
      if (address1 === FAILURE) {
      ...
      if (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          elements0[1] = address2;
          var address3 = FAILURE;
          address3 = this._read_typedefstruct();
          if (address3 !== FAILURE) {
            elements0[2] = address3;
            var address4 = FAILURE;
            var index4 = this._offset;
            ...
            if (elements1 === null) {
              ...
              address4 = new TreeNode19(this._input.substring(index5, this._offset), index5, elements1);
              this._offset = this._offset;
            }
            if (address4 === FAILURE) {
            ...
            if (address4 !== FAILURE) {
              ...
              var address7 = FAILURE;
              var index6 = this._offset;
              var index7 = this._offset, elements2 = new Array(2);
              var address8 = FAILURE;
              address8 = this._read_ws();
              if (address8 !== FAILURE) {
              ...
              if (elements2 === null) {
                ...
                address7 = new TreeNode20(this._input.substring(index7, this._offset), index7, elements2);
                this._offset = this._offset;
              }
              if (address7 === FAILURE) {
              ...
              if (address7 !== FAILURE) {
                ...
                var address10 = FAILURE;
                var index8 = this._offset;
                var index9 = this._offset, elements3 = new Array(2);
                var address11 = FAILURE;
                address11 = this._read_ws();
                if (address11 !== FAILURE) {
                  elements3[0] = address11;
                  var address12 = FAILURE;
                  address12 = this._read_extends();
                  if (address12 !== FAILURE) {
                    elements3[1] = address12;
                  } else {
                    elements3 = null;
                    this._offset = index9;
                  }
                ...
                if (elements3 === null) {
                  ...
                  address10 = new TreeNode21(this._input.substring(index9, this._offset), index9, elements3);
                  this._offset = this._offset;
                }
                if (address10 === FAILURE) {
                ...
                if (address10 !== FAILURE) {
                  ...
                  if (address13 === FAILURE) {
                    address13 = new TreeNode(this._input.substring(index10, index10), index10);
                    this._offset = index10;
                  }
                  if (address13 !== FAILURE) {
                    elements0[6] = address13;
                    var address14 = FAILURE;
                    var chunk0 = null;
                    if (this._offset < this._inputSize) {
                      chunk0 = this._input.substring(this._offset, this._offset + 1);
                    ...
                    if (address14 !== FAILURE) {
                      elements0[7] = address14;
                      var address15 = FAILURE;
                      var index11 = this._offset;
                      address15 = this._read_ws();
                      if (address15 === FAILURE) {
                        address15 = new TreeNode(this._input.substring(index11, index11), index11);
                        this._offset = index11;
                      }
                      if (address15 !== FAILURE) {
                        elements0[8] = address15;
                        var address16 = FAILURE;
                        address16 = this._read_structfields();
                        if (address16 !== FAILURE) {
                          elements0[9] = address16;
                          var address17 = FAILURE;
                          var index12 = this._offset;
                          address17 = this._read_ws();
                          if (address17 === FAILURE) {
                            address17 = new TreeNode(this._input.substring(index12, index12), index12);
                            this._offset = index12;
                          }
                          if (address17 !== FAILURE) {
                            elements0[10] = address17;
                            var address18 = FAILURE;
                            var chunk1 = null;
                            if (this._offset < this._inputSize) {
                              chunk1 = this._input.substring(this._offset, this._offset + 1);
                            ...
                            if (chunk1 === '}') {
                              address18 = new TreeNode(this._input.substring(this._offset, this._offset + 1), this._offset);
                              this._offset = this._offset + 1;
                            } else {
                              address18 = FAILURE;
                              if (this._offset > this._failure) {
                            ...
                            if (address18 !== FAILURE) {
                              elements0[11] = address18;
                              var address19 = FAILURE;
                              var index13 = this._offset;
                              address19 = this._read_ws();
                              if (address19 === FAILURE) {
                                address19 = new TreeNode(this._input.substring(index13, index13), index13);
                                this._offset = index13;
                              }
                              if (address19 !== FAILURE) {
                                elements0[12] = address19;
                                var address20 = FAILURE;
                                var index14 = this._offset;
                                address20 = this._read_idents();
                                if (address20 === FAILURE) {
                                  address20 = new TreeNode(this._input.substring(index14, index14), index14);
                                  this._offset = index14;
                                }
                                if (address20 !== FAILURE) {
                                  elements0[13] = address20;
                                  var address21 = FAILURE;
                                  var index15 = this._offset;
                                  address21 = this._read_ws();
                                  if (address21 === FAILURE) {
                                    address21 = new TreeNode(this._input.substring(index15, index15), index15);
                                    this._offset = index15;
                                  }
                                  if (address21 !== FAILURE) {
                                    elements0[14] = address21;
                                    var address22 = FAILURE;
                                    address22 = this._read_eol();
                                    if (address22 !== FAILURE) {
                                      elements0[15] = address22;
                                      var address23 = FAILURE;
                                      var index16 = this._offset;
                                      address23 = this._read_ws();
                                      if (address23 === FAILURE) {
                                        address23 = new TreeNode(this._input.substring(index16, index16), index16);
                                        this._offset = index16;
                                      }
                                      if (address23 !== FAILURE) {
                                        elements0[16] = address23;
                                      } else {
                                        elements0 = null;
                                        this._offset = index1;
                                      }
        ...
        if (address2 !== FAILURE) {
          ...
          if (address3 !== FAILURE) {
            ...
            if (elements1 === null) {
              ...
              address4 = new TreeNode23(this._input.substring(index5, this._offset), index5, elements1);
              this._offset = this._offset;
            }
            if (address4 === FAILURE) {
              address4 = new TreeNode(this._input.substring(index4, index4), index4);
            ...
            if (address4 !== FAILURE) {
              ...
              if (elements2 === null) {
                ...
                address7 = new TreeNode24(this._input.substring(index7, this._offset), index7, elements2);
                this._offset = this._offset;
              }
              if (address7 === FAILURE) {
                address7 = new TreeNode(this._input.substring(index6, index6), index6);
              ...
              if (address7 !== FAILURE) {
                ...
                if (elements3 === null) {
                  ...
                  address10 = new TreeNode25(this._input.substring(index9, this._offset), index9, elements3);
                  this._offset = this._offset;
                }
                if (address10 === FAILURE) {
                  address10 = new TreeNode(this._input.substring(index8, index8), index8);
    ...
    _read_extends: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._extends = this._cache._extends || {};
      var cached = this._cache._extends[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.extends(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._extends[index0] = [address0, this._offset];
      return address0;
    },
        ...
        if (address2 !== FAILURE) {
          ...
          while (address4 !== FAILURE) {
            ...
            if (elements2 === null) {
              ...
              address4 = new TreeNode28(this._input.substring(index4, this._offset), index4, elements2);
              this._offset = this._offset;
            }
            if (address4 !== FAILURE) {
    ...
    _read_lambdaexpr: function() {
      ...
      while (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address1 = new TreeNode29(this._input.substring(index2, this._offset), index2, elements1);
          this._offset = this._offset;
        }
        if (address1 !== FAILURE) {
          elements0.push(address1);
    ...
    _read_lambdamath: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address2 = new TreeNode31(this._input.substring(index3, this._offset), index3, elements1);
          this._offset = this._offset;
        }
        if (address2 === FAILURE) {
          address2 = new TreeNode(this._input.substring(index2, index2), index2);
                      ...
                      if (address9 !== FAILURE) {
                        ...
                        if (address10 !== FAILURE) {
                          ...
                          if (address11 !== FAILURE) {
                            ...
                            var address12 = FAILURE;
                            var index10 = this._offset;
                            address12 = this._read_comment1();
                            if (address12 === FAILURE) {
                              address12 = new TreeNode(this._input.substring(index10, index10), index10);
                              this._offset = index10;
                            }
                            if (address12 !== FAILURE) {
    ...
    _read_modifier: function() {
      ...
      if (address1 === FAILURE) {
        ...
        if (address1 === FAILURE) {
          ...
          var chunk2 = null;
          if (this._offset < this._inputSize) {
            chunk2 = this._input.substring(this._offset, this._offset + 6);
          }
          if (chunk2 === 'hidden') {
            address1 = new TreeNode(this._input.substring(this._offset, this._offset + 6), this._offset);
            this._offset = this._offset + 6;
          ...
          if (address1 === FAILURE) {
            ...
            var chunk3 = null;
            if (this._offset < this._inputSize) {
              chunk3 = this._input.substring(this._offset, this._offset + 8);
            }
            if (chunk3 === 'unsigned') {
            ...
            if (address1 === FAILURE) {
              ...
              var chunk4 = null;
              if (this._offset < this._inputSize) {
                chunk4 = this._input.substring(this._offset, this._offset + 8);
              }
              if (chunk4 === 'reversed') {
                address1 = new TreeNode(this._input.substring(this._offset, this._offset + 8), this._offset);
                this._offset = this._offset + 8;
    ...
    _read_transform: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._transform = this._cache._transform || {};
      var cached = this._cache._transform[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.transform(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._transform[index0] = [address0, this._offset];
      return address0;
    },

    _read_args: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._args = this._cache._args || {};
      var cached = this._cache._args[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
        ...
        if (address2 !== FAILURE) {
          ...
          while (address4 !== FAILURE) {
            ...
            if (elements2 === null) {
              ...
              address4 = new TreeNode38(this._input.substring(index4, this._offset), index4, elements2);
              this._offset = this._offset;
            }
            if (address4 !== FAILURE) {
              elements1.push(address4);
      ...
      this._cache._args[index0] = [address0, this._offset];
      return address0;
    },

    _read_arg: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._arg = this._cache._arg || {};
      var cached = this._cache._arg[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      this._cache._arg[index0] = [address0, this._offset];
      return address0;
    },
    ...
    _read_enumvalue: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._enumvalue = this._cache._enumvalue || {};
      var cached = this._cache._enumvalue[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.enumvalue(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._enumvalue[index0] = [address0, this._offset];
      return address0;
    },
        ...
        if (address2 !== FAILURE) {
          ...
          if (address3 !== FAILURE) {
            ...
            if (elements1 === null) {
              ...
              address4 = new TreeNode49(this._input.substring(index5, this._offset), index5, elements1);
              this._offset = this._offset;
            }
            if (address4 === FAILURE) {
              address4 = new TreeNode(this._input.substring(index4, index4), index4);
    ...
    _read_expression: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        while (address3 !== FAILURE) {
          ...
          if (elements2 === null) {
            ...
            address3 = new TreeNode52(this._input.substring(index3, this._offset), index3, elements2);
            this._offset = this._offset;
          }
          if (address3 !== FAILURE) {
            elements1.push(address3);
      ...
      if (elements0 === null) {
        ...
        address0 = new TreeNode51(this._input.substring(index1, this._offset), index1, elements0);
        this._offset = this._offset;
      }
    ...
    _read_debug: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._debug = this._cache._debug || {};
      var cached = this._cache._debug[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          elements0[1] = address2;
          var address3 = FAILURE;
          var remaining0 = 0, index5 = this._offset, elements1 = [], address4 = true;
          while (address4 !== FAILURE) {
            var chunk2 = null;
            if (this._offset < this._inputSize) {
              chunk2 = this._input.substring(this._offset, this._offset + 1);
          ...
          if (remaining0 <= 0) {
            address3 = new TreeNode(this._input.substring(index5, this._offset), index5, elements1);
            this._offset = this._offset;
          } else {
            address3 = FAILURE;
          }
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.debug(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._debug[index0] = [address0, this._offset];
      return address0;
    },
