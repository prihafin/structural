  ...
  var Grammar = {
          ...
          if (address3 !== FAILURE) {
            ...
            if (address4 !== FAILURE) {
              ...
              if (address5 !== FAILURE) {
                elements0[4] = address5;
                var address6 = FAILURE;
                address6 = this._read_structfields();
                if (address6 !== FAILURE) {
    ...
    _read_structfield: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address2 = new TreeNode8(this._input.substring(index3, this._offset), index3, elements1);
          this._offset = this._offset;
        }
        if (address2 === FAILURE) {
          ...
          if (address3 !== FAILURE) {
            ...
            if (address4 !== FAILURE) {
              ...
              if (address5 !== FAILURE) {
                elements0[4] = address5;
                var address6 = FAILURE;
                address6 = this._read_enumfields();
                if (address6 !== FAILURE) {
                  elements0[5] = address6;
                  var address7 = FAILURE;
                  var index4 = this._offset;
    ...
    _read_typedefstruct: function() {
      ...
      if (chunk0 === 'typedef struct') {
        address1 = new TreeNode(this._input.substring(this._offset, this._offset + 14), this._offset);
