(function() {
  ...
  var Grammar = {
      ...
      while (address1 !== FAILURE) {
        ...
        if (address1 === FAILURE) {
          ...
          if (address4 !== FAILURE) {
            ...
            address5 = this._read_structdecl();
            if (address5 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          if (address3 !== FAILURE) {
            ...
            if (address4 !== FAILURE) {
              ...
              if (address5 === FAILURE) {
                address5 = new TreeNode(this._input.substring(index2, index2), index2);
                this._offset = index2;
              }
              if (address5 !== FAILURE) {
                elements0[4] = address5;
                var address6 = FAILURE;
                address6 = this._read_fields();
                if (address6 !== FAILURE) {
                  ...
                  if (address7 !== FAILURE) {
                    ...
                    if (address8 !== FAILURE) {
                      ...
                      if (address9 === FAILURE) {
                        address9 = new TreeNode(this._input.substring(index4, index4), index4);
                        this._offset = index4;
                      }
                      if (address9 !== FAILURE) {
    ...
    _read_fields: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._fields = this._cache._fields || {};
      var cached = this._cache._fields[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      this._cache._fields[index0] = [address0, this._offset];
      return address0;
    },

    _read_field: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._field = this._cache._field || {};
      var cached = this._cache._field[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address2 = new TreeNode7(this._input.substring(index3, this._offset), index3, elements1);
          this._offset = this._offset;
        }
        if (address2 === FAILURE) {
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.field(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._field[index0] = [address0, this._offset];
      return address0;
    },
