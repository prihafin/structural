(function() {
  ...
  var Grammar = {
    ...
    _read__include: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache.__include = this._cache.__include || {};
      var cached = this._cache.__include[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      this._cache.__include[index0] = [address0, this._offset];
      return address0;
    },
    ...
    _read_pident: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._pident = this._cache._pident || {};
      var cached = this._cache._pident[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.pident(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._pident[index0] = [address0, this._offset];
      return address0;
    },
