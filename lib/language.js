  ...
  var Grammar = {
      ...
      if (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          if (address3 !== FAILURE) {
            ...
            var address4 = FAILURE;
            var index3 = this._offset;
            var index4 = this._offset, elements1 = new Array(4);
            var address5 = FAILURE;
            var index5 = this._offset;
            address5 = this._read_ws();
            if (address5 === FAILURE) {
            ...
            if (elements1 === null) {
              ...
              address4 = new TreeNode38(this._input.substring(index4, this._offset), index4, elements1);
              this._offset = this._offset;
            }
            if (address4 === FAILURE) {
              address4 = new TreeNode(this._input.substring(index3, index3), index3);
    ...
    _read_expression: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        while (address3 !== FAILURE) {
          ...
          if (elements2 === null) {
            ...
            address3 = new TreeNode41(this._input.substring(index3, this._offset), index3, elements2);
            this._offset = this._offset;
          }
          if (address3 !== FAILURE) {
            elements1.push(address3);
      ...
      if (elements0 === null) {
        ...
        address0 = new TreeNode40(this._input.substring(index1, this._offset), index1, elements0);
        this._offset = this._offset;
      }
