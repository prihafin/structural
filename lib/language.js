  ...
  var Grammar = {
      ...
      if (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          if (elements2 === null) {
            ...
            address5 = new TreeNode18(this._input.substring(index6, this._offset), index6, elements2);
            this._offset = this._offset;
          }
          if (address5 === FAILURE) {
            ...
            if (address8 !== FAILURE) {
              ...
              if (address9 !== FAILURE) {
                ...
                if (address10 !== FAILURE) {
                  ...
                  var address11 = FAILURE;
                  address11 = this._read_structfields();
                  if (address11 !== FAILURE) {
                    elements0[6] = address11;
                    var address12 = FAILURE;
                    var index10 = this._offset;
                    address12 = this._read_ws();
                    if (address12 === FAILURE) {
                    ...
                    if (address12 !== FAILURE) {
                      ...
                      if (address13 !== FAILURE) {
                        ...
                        if (address14 !== FAILURE) {
                          ...
                          var address15 = FAILURE;
                          var index12 = this._offset;
                          address15 = this._read_idents();
                          if (address15 === FAILURE) {
                            address15 = new TreeNode(this._input.substring(index12, index12), index12);
                            this._offset = index12;
                          }
                          if (address15 !== FAILURE) {
                            elements0[10] = address15;
                            var address16 = FAILURE;
                            var index13 = this._offset;
                            address16 = this._read_ws();
                            if (address16 === FAILURE) {
                              address16 = new TreeNode(this._input.substring(index13, index13), index13);
                              this._offset = index13;
                            }
                            if (address16 !== FAILURE) {
                              elements0[11] = address16;
                              var address17 = FAILURE;
                              address17 = this._read_eol();
                              if (address17 !== FAILURE) {
                                elements0[12] = address17;
                                var address18 = FAILURE;
                                var index14 = this._offset;
                                address18 = this._read_ws();
                                if (address18 === FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          if (address3 !== FAILURE) {
            ...
            if (elements1 === null) {
              ...
              address4 = new TreeNode20(this._input.substring(index4, this._offset), index4, elements1);
              this._offset = this._offset;
            }
            if (address4 === FAILURE) {
              address4 = new TreeNode(this._input.substring(index3, index3), index3);
              ...
              if (address7 !== FAILURE) {
                ...
                if (address8 !== FAILURE) {
                  ...
                  if (address9 !== FAILURE) {
                    ...
                    var address10 = FAILURE;
                    address10 = this._read_structfields();
                    if (address10 !== FAILURE) {
                      elements0[7] = address10;
                      var address11 = FAILURE;
                      var index7 = this._offset;
                      ...
                      if (address11 !== FAILURE) {
                        ...
                        if (address12 !== FAILURE) {
                          elements0[9] = address12;
                          var address13 = FAILURE;
                          var index8 = this._offset;
                          address13 = this._read_ws();
                          if (address13 === FAILURE) {
                            address13 = new TreeNode(this._input.substring(index8, index8), index8);
                            this._offset = index8;
                          }
                          if (address13 !== FAILURE) {
                            ...
                            if (address14 !== FAILURE) {
                              ...
                              if (address15 !== FAILURE) {
                                elements0[12] = address15;
                                var address16 = FAILURE;
                                address16 = this._read_eol();
                                if (address16 !== FAILURE) {
                                  elements0[13] = address16;
                                  var address17 = FAILURE;
                                  var index11 = this._offset;
        ...
        if (address2 !== FAILURE) {
          ...
          while (address4 !== FAILURE) {
            ...
            if (elements2 === null) {
              ...
              address4 = new TreeNode22(this._input.substring(index4, this._offset), index4, elements2);
              this._offset = this._offset;
            }
            if (address4 !== FAILURE) {
    ...
    _read_lambdaexpr: function() {
      ...
      while (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address1 = new TreeNode23(this._input.substring(index2, this._offset), index2, elements1);
          this._offset = this._offset;
        }
        if (address1 !== FAILURE) {
          elements0.push(address1);
    ...
    _read_lambdamath: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address2 = new TreeNode25(this._input.substring(index3, this._offset), index3, elements1);
          this._offset = this._offset;
        }
        if (address2 === FAILURE) {
          address2 = new TreeNode(this._input.substring(index2, index2), index2);
    ...
    _read_modifier: function() {
      ...
      if (address1 === FAILURE) {
        ...
        if (address1 === FAILURE) {
          ...
          var chunk2 = null;
          if (this._offset < this._inputSize) {
            chunk2 = this._input.substring(this._offset, this._offset + 8);
          }
          if (chunk2 === 'reversed') {
            address1 = new TreeNode(this._input.substring(this._offset, this._offset + 8), this._offset);
            this._offset = this._offset + 8;
        ...
        if (address2 !== FAILURE) {
          ...
          if (address3 !== FAILURE) {
            ...
            if (elements1 === null) {
              ...
              address4 = new TreeNode41(this._input.substring(index5, this._offset), index5, elements1);
              this._offset = this._offset;
            }
            if (address4 === FAILURE) {
              address4 = new TreeNode(this._input.substring(index4, index4), index4);
    ...
    _read_expression: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        while (address3 !== FAILURE) {
          ...
          if (elements2 === null) {
            ...
            address3 = new TreeNode44(this._input.substring(index3, this._offset), index3, elements2);
            this._offset = this._offset;
          }
          if (address3 !== FAILURE) {
            elements1.push(address3);
      ...
      if (elements0 === null) {
        ...
        address0 = new TreeNode43(this._input.substring(index1, this._offset), index1, elements0);
        this._offset = this._offset;
      }
