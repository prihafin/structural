(function() {
  ...
  var TreeNode18 = function(text, offset, elements) {
    ...
    this['structfields'] = elements[7];
    this['eol'] = elements[13];
  };
  ...
  var Grammar = {
    ...
    _read_typedefstructdecl: function() {
      ...
      var index1 = this._offset, elements0 = new Array(15);
      var address1 = FAILURE;
      ...
      if (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address2 = new TreeNode19(this._input.substring(index3, this._offset), index3, elements1);
          this._offset = this._offset;
        }
        if (address2 === FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          if (elements2 === null) {
            ...
            address5 = new TreeNode20(this._input.substring(index5, this._offset), index5, elements2);
            this._offset = this._offset;
          }
          if (address5 === FAILURE) {
          ...
          if (address5 !== FAILURE) {
            ...
            if (elements3 === null) {
              ...
              address8 = new TreeNode21(this._input.substring(index7, this._offset), index7, elements3);
              this._offset = this._offset;
            }
            if (address8 === FAILURE) {
              ...
              if (address11 !== FAILURE) {
                ...
                if (address12 !== FAILURE) {
                  ...
                  if (address13 !== FAILURE) {
                    ...
                    var address14 = FAILURE;
                    address14 = this._read_structfields();
                    if (address14 !== FAILURE) {
                      ...
                      if (address15 === FAILURE) {
                        address15 = new TreeNode(this._input.substring(index10, index10), index10);
                        this._offset = index10;
                      }
                      if (address15 !== FAILURE) {
                        ...
                        if (address16 !== FAILURE) {
                          ...
                          if (address17 === FAILURE) {
                            address17 = new TreeNode(this._input.substring(index11, index11), index11);
                            this._offset = index11;
                          }
                          if (address17 !== FAILURE) {
                            ...
                            var address18 = FAILURE;
                            var index12 = this._offset;
                            address18 = this._read_idents();
                            if (address18 === FAILURE) {
                              address18 = new TreeNode(this._input.substring(index12, index12), index12);
                              this._offset = index12;
                            }
                            if (address18 !== FAILURE) {
                              ...
                              if (address19 !== FAILURE) {
                                ...
                                if (address20 !== FAILURE) {
                                  ...
                                  if (address21 === FAILURE) {
                                    address21 = new TreeNode(this._input.substring(index14, index14), index14);
                                    this._offset = index14;
                                  }
                                  if (address21 !== FAILURE) {
    ...
    _read_structdecl: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address2 = new TreeNode23(this._input.substring(index3, this._offset), index3, elements1);
          this._offset = this._offset;
        }
        if (address2 === FAILURE) {
          address2 = new TreeNode(this._input.substring(index2, index2), index2);
        ...
        if (address2 !== FAILURE) {
          ...
          if (elements2 === null) {
            ...
            address5 = new TreeNode24(this._input.substring(index5, this._offset), index5, elements2);
            this._offset = this._offset;
          }
          if (address5 === FAILURE) {
            address5 = new TreeNode(this._input.substring(index4, index4), index4);
          ...
          if (address5 !== FAILURE) {
            ...
            if (elements3 === null) {
              ...
              address8 = new TreeNode25(this._input.substring(index7, this._offset), index7, elements3);
              this._offset = this._offset;
            }
            if (address8 === FAILURE) {
              address8 = new TreeNode(this._input.substring(index6, index6), index6);
